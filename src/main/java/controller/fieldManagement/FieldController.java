...
public class FieldController {
	...
	public void doFieldActionByFieldType(Player player, Field currentField) {
		...
		switch (currentField.getFieldType())
		{
			...
			case Boat:
				BoatAction boatAction = new BoatAction(player, players, messageMap, guiController,generalActionController, currentField);
				boatAction.action();
				break;
			...
			case Brewery:
				BreweryAction breweryAction = new BreweryAction(player, players, messageMap, guiController, cup,
